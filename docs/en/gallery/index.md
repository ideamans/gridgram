---
description: 'A collection of .gg diagrams organized by domain, each rendered live at build time. Together they show the DSL reaches past cloud architecture boxes.'
---
# Gallery

---
description: 'Examples for a three-stage supply chain with returns, multi-tier suppliers, inventory flow, and reverse logistics. Dashed edges carry the return paths.'
---
# Supply chain
